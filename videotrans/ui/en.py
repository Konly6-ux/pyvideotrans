...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.rephrase.setToolTip('当选择faster/openai-whisper/Deepgram渠道时将使用大模型重新断句，若失败将使用原始分段' if config.defaulelang=='zh' else 'Valid when selecting the fast/openai-whisper/Deep program')
        ...
        # 添加AI自动对齐按钮
        self.auto_align = QtWidgets.QCheckBox(self.layoutWidget)
        self.auto_align.setMinimumSize(QtCore.QSize(0, 30))
        self.auto_align.setObjectName("auto_align")
        self.auto_align.setToolTip('使用AI自动对齐配音和字幕，解决配音时长不匹配问题' if config.defaulelang=='zh' else 'Use AI to automatically align dubbing and subtitles to solve dubbing duration mismatch issues')
        self.auto_align.setText('AI自动对齐' if config.defaulelang=='zh' else 'AI Auto Align')
        ...
        self.gaoji_layout_inner2.addWidget(self.auto_align)
        ...
        # 创建动作
        self.action_biaozhun = QAction(MainWindow)
        ...
        self.action_tiquzimu = QAction(MainWindow)
        self.action_tiquzimu.setCheckable(True)
        self.action_tiquzimu.setObjectName("action_tiquzimu")

        self.action_peiyin = QAction(MainWindow)
        self.action_peiyin.setCheckable(True)
        self.action_peiyin.setObjectName("action_peiyin")

        self.action_fanyisrt = QAction(MainWindow)
        self.action_fanyisrt.setCheckable(True)
        self.action_fanyisrt.setObjectName("action_fanyisrt")

        self.action_vas = QAction(MainWindow)
        self.action_vas.setCheckable(True)
        self.action_vas.setObjectName("action_vas")

        self.action_videoandaudio = QAction(MainWindow)
        self.action_videoandaudio.setCheckable(True)
        self.action_videoandaudio.setObjectName("action_videoandaudio")
        
        self.action_about = QAction(MainWindow)
        self.action_about.setObjectName("action_about")

        self.action_clearcache = QAction(MainWindow)
        ...
        self.toolBar.addAction(self.action_peiyin)
        self.toolBar.addAction(self.action_fanyisrt)
        self.toolBar.addAction(self.action_vas)
        self.toolBar.addAction(self.action_videoandaudio)
        
        self.menubar.addAction(self.menu_file.menuAction())
        self.menu_file.addAction(self.action_clearcache)
    ...
    def retranslateUi(self):
        ...
        self.menu_file.setTitle(config.uilanglist.get("&Setting"))
        ...
        self.action_peiyin.setText('为字幕创建配音' if config.defaulelang == 'zh' else 'Create Dubbing For Subtitle')
        self.action_peiyin.setToolTip(
            '为已有的字幕文件创建配音' if config.defaulelang == 'zh' else 'Create dubbing for existing subtitle files')

        self.action_fanyisrt.setText('字幕翻译' if config.defaulelang == 'zh' else 'Translate Subtitle Files')
        self.action_fanyisrt.setToolTip(
            '将字幕文件翻译为其他语言' if config.defaulelang == 'zh' else 'Translate subtitle files to other languages')
        
        self.action_vas.setText('音视频合并' if config.defaulelang == 'zh' else 'Merge Video And Audio')
        self.action_vas.setToolTip(
            '将视频和音频合并' if config.defaulelang == 'zh' else 'Merge video and audio files')

        self.action_videoandaudio.setText('视频字幕合并' if config.defaulelang == 'zh' else 'Merge Video And Subtitle')
        self.action_videoandaudio.setToolTip(
            '将视频和字幕文件合并' if config.defaulelang == 'zh' else 'Merge video and subtitle files')

        self.action_about.setText('关于' if config.defaulelang == 'zh' else 'About')
        self.action_clearcache.setText('清理缓存' if config.defaulelang == 'zh' else 'Clear Cache')
